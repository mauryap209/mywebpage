...
< div className="card-container">
    <div className ="card">
      ...
      <div className="card-content">
        ...
        <p className="card-text">Building dynamic and responsive web applications using React</p>
    ...
    <div className ="card">
      ...
      <div className="card-content">
        ...
        <p className="card-text">Creating educational platforms for universities and schools.</p>
    ...
    <div className="card">
      ...
      <div className="card-content">
        ...
        <p className="card-text">Showcasing nature through interactive web projects.</p>
    ...
    <div className="card">
      ...
      <div className="card-content">
        ...
        <p className="card-text">Creating fun and educational websites for kids.</p>
